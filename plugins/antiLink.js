...
bot(
  ...
  async (message, match) => {
    ...
    if (!match) {
      ...
      // 	],
      // 	'Example\nhttps://github.com/whatsapp-bot-md/wiki/antilink',
      // 	'Antilink'
      // )
      ...
      // 				urlButton: {
      // 					text: 'Example',
      // 					url: 'https://github.com/whatsapp-bot-md/wiki/antilink',
      // 				},
      // 			},
      // 			{
      // 				button: {
    ...
    if (match == 'on' || match == 'off') {
      if (match == 'off' && !antilink) return await message.send('_AntiLink is not enabled in this group chat._')
