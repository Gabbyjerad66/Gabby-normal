...
module.exports = {
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'Gabby',
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || ' &mention detected sending link, goodbye my friend, i wish i could help',
  ANTISPAM_MSG: process.env.ANTISPAM_MSG || ' &mention detected spamming, goodbye my friend, i wish i could help',
  ANTIWORDS_MSG: process.env.ANTIWORDS_MSG || ' &mention kicked detected sending a forbidden word, thats not acceptable dear, goodbye',
  ...
  WARN_MESSAGE:
    ...
    '✦G✦warning! you can do better that this friend, so dont piss me off. ✦G✦\n*User :* &mention\n*Warn :* &warn\n*Remaining :* &remaining',
  WARN_RESET_MESSAGE:
    process.env.WARN_RESET_MESSAGE || `WARN RESET\nUser : &mention\nRemaining : &remaining`,
  WARN_KICK_MESSAGE: process.env.WARN_KICK_MESSAGE || '&mention kicked your warn limit is up goodbye',
